...
class RecformerForSeqRec(LongformerPreTrainedModel):
    ...
    def forward(self,
                ...
                return_users: Optional[bool] = False, 
                ):
        ...
        pooler_output = outputs.pooler_output # (bs, hidden_size)   # user embedding

        user_embed = pooler_output if return_users else None

        if labels is None:
            return self.similarity_score(pooler_output, candidates), user_embed
